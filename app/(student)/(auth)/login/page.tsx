						...
						<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
							<div className="space-y-4">
								<div className="group relative">
									...
									/>
									<UserCircle className="absolute right-4 top-[38px] size-5 text-ab-text-secondary transition-colors group-focus-within:text-ab-primary" />
								</div>
								...
								<div className="group relative">
									<FormField
										...
										type="password"
									/>
									<Shield className="absolute right-4 top-[38px] size-5 text-ab-text-secondary transition-colors group-focus-within:text-ab-primary" />
								</div>
							</div>
