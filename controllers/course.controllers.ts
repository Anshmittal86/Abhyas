...
export async function getCourseById(request: NextRequest, { params }: { params: Promise<{ courseId: string }> }) {
  try {
    const { userId: adminId, userRole: role } = requireRole(request, ['admin']);
...
export async function updateCourse(request: NextRequest, { params }: { params: Promise<{ courseId: string }> }) {
  try {
    const { userId: adminId, userRole: role } = requireRole(request, ['admin']);
...
export async function deleteCourse(request: NextRequest, { params }: { params: Promise<{ courseId: string }> }) {
  try {
    const { userId: adminId, userRole: role } = requireRole(request, ['admin']);
