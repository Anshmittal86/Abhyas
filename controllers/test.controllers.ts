...
export async function getTestById(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    const { userId: adminId, userRole: role } = requireRole(request, ['admin']);
...
export async function updateTest(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    const { userId: adminId, userRole: role } = requireRole(request, ['admin']);
...
export async function deleteTest(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    const { userId: adminId, userRole: role } = requireRole(request, ['admin']);
